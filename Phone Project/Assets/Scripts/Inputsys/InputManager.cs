...
[DefaultExecutionOrder(-1)] // starts before other scripts
public class InputManager : Singleton<InputManager> // calls the silgleton to keep only one script
{

    public delegate void StartTouchEvent(Vector2 posision, float time);
    public event StartTouchEvent OnStartTouch;
    public delegate void EndTouchEvent(Vector2 posision, float time);
    ...
    {
        //Debug.Log("Stopped Touching " + touchControls.Touch.TouchPosition.ReadValue<Vector2>());
